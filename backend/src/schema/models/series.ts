...
export const series = (
  ...
  Series.associate = (models) => {
    Series.hasMany(models.Image, {
      foreignKey: "movie_tv_id",
      as: "images",
    });
    ...
    Series.hasMany(models.Cast, {
      foreignKey: "movie_tv_id",
      as: "casts",
    });
    Series.hasMany(models.Crew, {
      foreignKey: "movie_tv_id",
      as: "crews",
    });
    Series.hasMany(models.Translation, {
      foreignKey: "movie_tv_id",
      as: "translations",
    });
    Series.hasMany(models.GuestStar, {
